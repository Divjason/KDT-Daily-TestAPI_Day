window.TEST_DATA = {
  ...
  questions: [
    ...
    },
    {
      ...
      score: 4,
      question:
        "customer_name, product_name, quantity를 3 Table JOIN하면 무엇을 알 수 있습니까?",
      options: [
        "거주 지역",
    ...
    },
    {
      ...
      scenario:
        "customer_name, order_count / COUNT(*) + GROUP BY + ORDER BY DESC",
      placeholder: "SQL을 작성하세요.",
    },
    {
      id: "q20",
      ...
      scenario:
        "customer_name, product_name, price / 3 Table JOIN + AVG(price) Subquery + 가격 DESC",
      placeholder: "SQL을 작성하세요.",
    },
  ],
};
